...
#clinical info
meta <- read.csv("../input_data/metabolism_meta.csv",header = T)

# read metabolism  data
metabolism <-read.csv("../input_data/metabolism_expr.csv",row.names = 1,header = 1)
...
saveRDS(genelist, "../result/IBD.cpd.mpse.rds")
