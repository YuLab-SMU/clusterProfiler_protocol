...
ggsave("IBD_2_subtypes_example/result/IBD_2_subtypes_in_metagenome_ORA(treeplot).pdf", width = 15, height = 5.5)
...
fig = aplot::plot_list(p1, p2, tag_levels='A', tag_size=15, widths=c(1, .8))
ggsave(fig, file="IBD_2_subtypes_example/result/fig.pdf", width=13, height=6.5)
ggsave(fig, file="IBD_2_subtypes_example/result/fig.png", width=13, height=6.5)
