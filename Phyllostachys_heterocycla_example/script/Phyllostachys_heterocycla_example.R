...
tf_annot_plot <- ggplot(
    ...
    geom_tile() + scale_fill_manual(values = rainbow(11, alpha = .4)) + theme_bw() +
    theme_classic() +
...
insert_bottom(tf_annot_plot, enrich_plot, height = 10) |>
    insert_bottom(enrich_pathway_plot, height = 10)
